 ...
 */
class sizeblizzard : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_sizeblizzard, container, false)
    ...
    fun sent_data(name_fb: String, image_fb: String, name: String, image1: String, image_cup: String, sizeM: String, sizeL: String, sizeXL: String): sizeblizzard {

        val fragment = sizeblizzard()
        val bundle = Bundle()
