 ...
 */
class menucake : Fragment() {

    override fun onCreateView(inflater : LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_menucake, container, false)
...
//        }
        ...
        val mMessagesRef = mRootRef.child("data_cake")
        ...
        mMessagesRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                //ตั้งค่า Adapter
                val adapter = CakeRecyclerAdapter(activity!!.baseContext,list)
    ...
    fun sent_data(name_fb: String, image_fb: String): menucake {

        val fragment = menucake()
        val bundle = Bundle()
