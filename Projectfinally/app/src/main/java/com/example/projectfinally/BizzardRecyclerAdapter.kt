...
class BizzardRecyclerAdapter(context: Context, val dataSource: JSONArray) : RecyclerView.Adapter<BizzardRecyclerAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.layout.setOnClickListener{
            val sizeblizzard = sizeblizzard().sent_data(
            ...
            transaction.replace(R.id.layout, sizeblizzard,"sizeblizzard")
            transaction.addToBackStack("sizeblizzard")
            transaction.commit()
        }
    }
